/*
 * Partial copy of LaunchWrapper's Launch class, modified to be more useful for testing (to be used via IsolatedLaunch):
 * - Throw errors instead of exiting JVM
 * - Directly accept relevant options instead of parsing them from arguments
 * - Add "com.example.mod.LoadState" to class loader exclusions
 *
 * License of copied code is unclear, do not redistribute!
 */
...
public class TestableLaunch {
    public TestableLaunch() {
    ...
    public void launch(File gameDir, String tweakClass) throws Exception {
        minecraftHome = gameDir;
        final List<String> tweakClassNames = new ArrayList<>();
        tweakClassNames.add(tweakClass);
        ...
        do {
            ...
            for (final Iterator<ITweaker> it = tweakers.iterator(); it.hasNext(); ) {
                ...
                tweaker.acceptOptions(Collections.emptyList(), minecraftHome, assetsDir, null);
